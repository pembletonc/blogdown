...
```{r}
influence_snapshot("UNICEF")

```

With the addition of other metrics and when broken down during specific time periods (e.g. to measure a campaign's influence), this could be a powerful tool to determine influence.
