...
I'm not exactly fundamentally against Microsoft Excel, but I'm not a member of the fan club either, so to speak. Nonetheless, an important component of datascience is a) giving clients their desired output, and b) ensuring it is an output best suited to their needs - and sometimes that means giving an output in the form of an excel workbook. 
